...
|---|---|---|
| 1.ª evaluación | T1 Scratch | 21 |
| 2.ª evaluación | T2 micro:bit | 15 troncales + 12 ampliaciones |
| 3.ª evaluación | T3 Ciberseguridad | 18 |

> **Las 21 sesiones no llenan el trimestre, y es a propósito.** A 2 sesiones
> por semana son unas 10 semanas y media, y el primero da para unas 13. Esas clases de
...
Antes del proyecto hay una sesión aparte, la **S17 · Depuración**: cinco programas con un
fallo plantado cada uno, en un `.sb3` que el alumnado se descarga. No enseña bloques nuevos;
enseña a encontrar un fallo sin tocar cosas al azar, que es justo lo que van a necesitar en
las cuatro siguientes. La **S20** retoma el método, ya sobre el juego de cada uno.
...
se evalúa no es el juego, es la versión de cada uno**: la ficha de la S18 pide
tres cambios concretos sobre la base. Así se puede mandar el mismo juego a toda
la clase sin que las presentaciones de la S21 sean todas iguales.
...
|---|---|---|---|---|
| T1 | `t1-scratch` | Scratch | 21 | **Completo**: hub, índice, presentación y las 21 sesiones. Se generan desde `generadores-t1/` |
